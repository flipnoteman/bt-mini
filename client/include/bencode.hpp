/*
 * This content was created by @jimporter on github.com.
 * It is licensed under a BSD 3-Clause license.
 * Link: https://github.com/jimporter/bencode.hpp
 *
 */
...
template <output_iterator_ref Iter> class list_encoder {
public:
...
template <output_iterator_ref Iter> class dict_encoder {
public:
...
namespace detail {
template <detail::output_iterator_ref Iter> class encode_visitor {
public:
...
template <typename... T> void encode_to(std::ostream &os, T &&...t) {
